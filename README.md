...
nombre, por ejemplo `["codigo:Sentimiento de culpa", "fusionar"]`. Y un botón de la barra de herramientas del
gestor de archivos, con `["archivos", "importar"]`, tomando los `id` de `CURSO.interfaz.barra_archivos`.
